...
export const EditorData = () => (
  <div>
    ...
    <p>
      React is a powerful JavaScript library designed for building user interfaces. It supports gradual adoption, so you can use as little or as much as you need.
    </p>

    <h4>🧪 Try React Online</h4>
    <p>
      Explore React in online playgrounds like <a href="https://codesandbox.io" target="_blank" rel="noopener noreferrer">CodeSandbox</a>, <a href="https://stackblitz.com" target="_blank" rel="noopener noreferrer">StackBlitz</a>, or <a href="https://codepen.io" target="_blank" rel="noopener noreferrer">CodePen</a>.
    </p>

    <h4>⚙️ Add React to Your Website</h4>
    <p>
      You can add React to any HTML page in just a minute using a simple script tag. Expand it gradually as your app grows.
    </p>

    <h4>🚀 Create a New React App</h4>
    <p>
      Start with <code>npx create-react-app my-app</code> to set up a modern React project with no build configuration.
    </p>

    <h4>📚 Learn React</h4>
    <p>
      Whether you're a beginner or switching from design/development, React offers docs and tutorials for all levels:
    </p>
    <ul>
      <li>📘 <strong>Step-by-step Guide:</strong> Covers React concepts clearly.</li>
      <li>👩‍💻 <strong>Practical Tutorial:</strong> Hands-on project-based learning.</li>
      <li>🎨 <strong>For Designers:</strong> Learn how to use React for UI/UX.</li>
    </ul>

    <h4>💡 JavaScript Basics</h4>
    <p>
      It's helpful to have some JavaScript knowledge. If you're just starting out, check the <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide" target="_blank" rel="noopener noreferrer">JS Guide by MDN</a>.
    </p>
...
const areaChartData = [
  [
    ...
    { x: new Date(2016, 0, 1), y: 3.2 },
    { x: new Date(2017, 0, 1), y: 3.8 },
    { x: new Date(2018, 0, 1), y: 4.1 },
    { x: new Date(2019, 0, 1), y: 3.9 },
    { x: new Date(2020, 0, 1), y: 2.1 }, // COVID dip
    { x: new Date(2021, 0, 1), y: 4.5 },
    { x: new Date(2022, 0, 1), y: 5.1 },
    { x: new Date(2023, 0, 1), y: 5.6 },
    { x: new Date(2024, 0, 1), y: 6.0 },
  ],
  [
    { x: new Date(2015, 0, 1), y: 1.5 },
    { x: new Date(2016, 0, 1), y: 2.3 },
    { x: new Date(2017, 0, 1), y: 2.6 },
    { x: new Date(2018, 0, 1), y: 3.1 },
    { x: new Date(2019, 0, 1), y: 2.8 },
    { x: new Date(2020, 0, 1), y: 1.2 },
    { x: new Date(2021, 0, 1), y: 3.3 },
    { x: new Date(2022, 0, 1), y: 3.7 },
    { x: new Date(2023, 0, 1), y: 4.0 },
    { x: new Date(2024, 0, 1), y: 4.3 },
  ],
  [
    { x: new Date(2015, 0, 1), y: 1.2 },
    { x: new Date(2016, 0, 1), y: 1.6 },
    { x: new Date(2017, 0, 1), y: 1.9 },
    { x: new Date(2018, 0, 1), y: 2.4 },
    { x: new Date(2019, 0, 1), y: 2.7 },
    { x: new Date(2020, 0, 1), y: 1.5 },
    { x: new Date(2021, 0, 1), y: 2.9 },
    { x: new Date(2022, 0, 1), y: 3.3 },
    { x: new Date(2023, 0, 1), y: 3.5 },
    { x: new Date(2024, 0, 1), y: 3.9 },
  ],
];
...
// Bar chart data representing different metrics across Indian cities
...
// Bar chart custom series using Indian metric labels
...
export const earningData = [
  {
    ...
    percentage: '+5.4%',
    title: 'Customers',
    iconColor: '#0284C7',        // Tailwind Blue-600
    iconBg: '#E0F2FE',            // Light blue background
    pcColor: 'green-600',
  },
  {
    icon: <BsBoxSeam />,
...
export const themeColors = [
  ...
  {
    name: 'indian-gold',
    color: '#C084FC',  // A rich violet/gold shade
  },
];
...
export const scheduleData = [
  {
    Id: 1,
    Subject: 'Solar Flare Impact Analysis',
    Location: 'Houston Space Center',
    StartTime: '2025-07-15T06:00:00.000Z',
    EndTime: '2025-07-15T07:30:00.000Z',
    CategoryColor: '#ff5733',
  },
  {
    Id: 2,
    Subject: 'Asteroid Collision Report',
    Location: 'Chicago',
    StartTime: '2025-07-16T08:30:00.000Z',
    EndTime: '2025-07-16T10:30:00.000Z',
    CategoryColor: '#3375ff',
  },
  {
    Id: 3,
    Subject: 'Lunar Eclipse Observation',
    Location: 'Cape Canaveral',
    StartTime: '2025-07-17T06:00:00.000Z',
    EndTime: '2025-07-17T07:30:00.000Z',
    CategoryColor: '#33cc33',
  },
  {
    Id: 4,
    Subject: 'Meteor Shower Forecast',
    Location: 'Vandenberg AFB',
    StartTime: '2025-07-18T09:30:00.000Z',
    EndTime: '2025-07-18T11:00:00.000Z',
    CategoryColor: '#ff9900',
  },
  {
    Id: 5,
    Subject: 'Galactic Core Exploration',
    Location: 'Kennedy Space Center',
    StartTime: '2025-07-19T08:30:00.000Z',
    EndTime: '2025-07-19T10:30:00.000Z',
    CategoryColor: '#009999',
  },
  {
    Id: 6,
    Subject: 'Bermuda Triangle Mysteries',
    Location: 'Miami',
    StartTime: '2025-07-19T06:00:00.000Z',
    EndTime: '2025-07-19T07:30:00.000Z',
    CategoryColor: '#cc6600',
  },
  {
    Id: 7,
    Subject: 'Arctic Ice Melting Patterns',
    Location: 'Alaska',
    StartTime: '2025-07-20T07:30:00.000Z',
    EndTime: '2025-07-20T09:00:00.000Z',
    CategoryColor: '#66cc33',
  },
  {
    Id: 8,
    Subject: 'Mars Colonization Plans',
    Location: 'Mars Research Lab',
  ...
  {
    Id: 9,
    Subject: 'Alien Signal Detection',
    Location: 'Deep Space Network',
    StartTime: '2025-07-23T07:30:00.000Z',
    EndTime: '2025-07-23T09:30:00.000Z',
    CategoryColor: '#339933',
  },
  {
    Id: 10,
    Subject: 'Wildlife Conservation Efforts',
    Location: 'Amazon Rainforest',
    StartTime: '2025-07-25T07:30:00.000Z',
    EndTime: '2025-07-25T09:30:00.000Z',
    CategoryColor: '#cc3300',
  },
  {
    Id: 11,
    Subject: 'Advanced Astrophotography',
    Location: 'London Observatory',
    StartTime: '2025-07-26T06:00:00.000Z',
    EndTime: '2025-07-26T07:30:00.000Z',
    CategoryColor: '#009966',
  },
  {
    Id: 12,
    Subject: 'Genetics of Canines',
    Location: 'Stockholm Veterinary Lab',
    StartTime: '2025-07-12T06:30:00.000Z',
    EndTime: '2025-07-12T08:00:00.000Z',
    CategoryColor: '#cc9900',
  },
  {
    Id: 13,
    Subject: 'Andromeda Galaxy Studies',
    Location: 'Houston Space Center',
    StartTime: '2025-07-10T07:00:00.000Z',
    EndTime: '2025-07-10T09:00:00.000Z',
    CategoryColor: '#33aa33',
  },
  {
    Id: 14,
    Subject: 'Extraterrestrial Life Theories',
    Location: 'Research Center USA',
    StartTime: '2025-07-09T06:30:00.000Z',
    EndTime: '2025-07-09T08:00:00.000Z',
    CategoryColor: '#3366cc',
  },
  {
    Id: 15,
    Subject: 'Hummingbird Behavior Analysis',
    Location: 'California',
    StartTime: '2025-07-24T06:00:00.000Z',
    EndTime: '2025-07-24T07:30:00.000Z',
    CategoryColor: '#339933',
  },
  {
    Id: 16,
    Subject: 'Northern Lights Research',
    Location: 'Alaska',
    StartTime: '2025-07-27T07:30:00.000Z',
    EndTime: '2025-07-27T09:30:00.000Z',
    CategoryColor: '#cc3300',
  },
  {
    Id: 17,
    Subject: 'Seasonal Cycle Effects',
    Location: 'Research Center USA',
    StartTime: '2025-07-16T01:00:00.000Z',
    EndTime: '2025-07-16T03:00:00.000Z',
    CategoryColor: '#009999',
  },
  {
    Id: 18,
    Subject: 'Planetary System Analysis',
    Location: 'Space Telescope HQ',
    StartTime: '2025-07-16T12:30:00.000Z',
    EndTime: '2025-07-16T14:00:00.000Z',
    CategoryColor: '#cc9900',
  },
  {
    Id: 19,
    Subject: 'Bumblebee Lifecycle Study',
  ...
  {
    Id: 20,
    Subject: 'Alien Communication Methods',
    Location: 'Mars Research Lab',
    StartTime: '2025-07-19T11:30:00.000Z',
    EndTime: '2025-07-19T13:30:00.000Z',
    CategoryColor: '#cc3300',
  },
  {
    Id: 21,
    Subject: 'Astrobiology Advances',
    Location: 'Kennedy Space Center',
    StartTime: '2025-07-15T10:30:00.000Z',
    EndTime: '2025-07-15T12:30:00.000Z',
    CategoryColor: '#cc3300',
  },
  {
    Id: 22,
    Subject: 'Seasonal Changes Impact',
    Location: 'Research Center USA',
    StartTime: '2025-07-17T11:00:00.000Z',
    EndTime: '2025-07-17T12:30:00.000Z',
    CategoryColor: '#009999',
  },
  {
    Id: 23,
    Subject: 'Aurora Borealis Watching',
    Location: 'Greenland',
  ...
  },
  {
    ...
    EndTime: '2025-07-21T11:00:00.000Z',
    CategoryColor: '#339933',
  },
];
...
export const lineChartData = [
  [
    ...
    { x: new Date(2016, 0, 1), y: 35 },
    { x: new Date(2017, 0, 1), y: 40 },
    { x: new Date(2018, 0, 1), y: 45 },
    { x: new Date(2019, 0, 1), y: 50 },
    { x: new Date(2020, 0, 1), y: 55 },
    { x: new Date(2021, 0, 1), y: 60 },
  ],
  [
    { x: new Date(2015, 0, 1), y: 25 },
    { x: new Date(2016, 0, 1), y: 30 },
    { x: new Date(2017, 0, 1), y: 35 },
    { x: new Date(2018, 0, 1), y: 40 },
    { x: new Date(2019, 0, 1), y: 45 },
...
export const dropdownData = [
  { Id: '1', Time: 'January 2024' },
  { Id: '2', Time: 'February 2024' },
  { Id: '3', Time: 'March 2024' },
];
...
export const kanbanData = [
  {
    ...
    Status: 'Open',
    Summary: 'Design and implement login screen UI',
    Type: 'Story',
    Priority: 'High',
    Tags: 'UI,Login',
    Estimate: 3,
    ...
    RankId: 1,
    Color: '#02897B',
    ClassName: 'e-story, e-high, e-priya-sharma',
  },
  {
    Id: 'Task 102',
    Title: 'Fix signup API bug',
    Status: 'InProgress',
    Summary: 'Resolve server-side validation issue',
    Type: 'Bug',
    Priority: 'Critical',
    Tags: 'API,Signup',
    Estimate: 2,
    ...
    RankId: 2,
    Color: '#E64A19',
    ClassName: 'e-bug, e-critical, e-rahul-mehta',
  },
  {
    Id: 'Task 103',
    Title: 'Add password toggle',
    Status: 'Review',
    Summary: 'Allow users to show/hide passwords on login screen',
    Type: 'Improvement',
    Priority: 'Normal',
    Tags: 'UX,Password',
    Estimate: 1,
    Assignee: 'Sanya Verma',
    RankId: 3,
    Color: '#673AB8',
    ClassName: 'e-improvement, e-normal, e-sanya-verma',
  },
  {
    Id: 'Task 104',
    Title: 'Deploy to staging',
    Status: 'Testing',
    Summary: 'Push recent features to staging for QA testing',
    Type: 'Others',
    Priority: 'Low',
    ...
    RankId: 1,
    Color: '#1F88E5',
    ClassName: 'e-others, e-low, e-arjun-kapoor',
  },
  {
    Id: 'Task 105',
    ...
    RankId: 2,
    Color: '#02897B',
    ClassName: 'e-story, e-normal, e-meera-singh',
  },
  {
    Id: 'Task 106',
    Title: 'Update user profile page',
    Status: 'Close',
    Summary: 'Fix layout issues and update UI for user profile',
    Type: 'Improvement',
    Priority: 'High',
    Tags: 'Profile,UX',
    Estimate: 3.5,
    ...
    RankId: 3,
    Color: '#673AB8',
    ClassName: 'e-improvement, e-high, e-aman-joshi',
  },
  {
    Id: 'Task 107',
    Title: 'Implement forgot password',
    Status: 'Open',
    Summary: 'Add forgot password feature with email support',
    Type: 'Story',
    Priority: 'High',
    Tags: 'Auth,Email',
    Estimate: 4,
  ...
  },
  {
    ...
    Status: 'InProgress',
    Summary: 'Resolve issues in the dark mode toggle component',
    Type: 'Bug',
    Priority: 'Normal',
    Tags: 'UI,DarkMode',
    Estimate: 2,
    ...
    RankId: 4,
    Color: '#E64A19',
    ClassName: 'e-bug, e-normal, e-sanya-verma',
  },
  {
    Id: 'Task 109',
    Title: 'Optimize image loading',
    Status: 'Review',
    Summary: 'Use lazy loading for better performance',
    Type: 'Improvement',
    Priority: 'Normal',
    ...
    RankId: 5,
    Color: '#673AB8',
    ClassName: 'e-improvement, e-normal, e-rahul-mehta',
  },
  {
    Id: 'Task 110',
    Title: 'Add contact form validation',
    Status: 'Testing',
    Summary: 'Ensure all fields in contact form are validated',
    Type: 'Story',
    Priority: 'High',
    ...
    RankId: 3,
    Color: '#02897B',
    ClassName: 'e-story, e-high, e-meera-singh',
  },
  {
    Id: 'Task 111',
    Title: 'Set up CI/CD pipeline',
    Status: 'Validate',
    Summary: 'Configure GitHub Actions for build and deploy',
    Type: 'Epic',
    Priority: 'Critical',
    Tags: 'DevOps,CI/CD',
    Estimate: 5,
    ...
    RankId: 2,
    Color: '#e91e64',
    ClassName: 'e-epic, e-critical, e-arjun-kapoor',
  },
  {
    Id: 'Task 112',
    Title: 'Refactor Redux store',
    Status: 'InProgress',
    Summary: 'Improve state structure and separate concerns',
    Type: 'Improvement',
    Priority: 'High',
    Tags: 'Redux,Refactor',
    Estimate: 4,
  ...
  },
  {
    ...
    Status: 'Review',
    Summary: 'Fix UI issues for small screen devices',
    Type: 'Bug',
    Priority: 'Critical',
    ...
    RankId: 5,
    Color: '#E64A19',
    ClassName: 'e-bug, e-critical, e-sanya-verma',
  },
  {
    Id: 'Task 114',
    Title: 'Research PWA support',
    Status: 'Open',
    Summary: 'Explore adding Progressive Web App features',
    Type: 'Others',
    Priority: 'Low',
    Tags: 'PWA,Research',
    Estimate: 2,
    ...
    RankId: 6,
    Color: '#1F88E5',
    ClassName: 'e-others, e-low, e-rahul-mehta',
  },
  {
    Id: 'Task 115',
    Title: 'Document API endpoints',
    Status: 'Close',
    Summary: 'Write Swagger docs for all backend APIs',
    Type: 'Story',
    Priority: 'Normal',
    Tags: 'Docs,Swagger',
    Estimate: 3,
...
export const PyramidData = [
  { x: 'Sweets & Snacks', y: 150, text: '150 cal' },
  { x: 'Milk, Curd, Paneer', y: 420, text: '420 cal' },
  { x: 'Vegetables (Curry, Sabzi)', y: 480, text: '480 cal' },
  { x: 'Dal, Egg, Chicken, Fish', y: 500, text: '500 cal' },
  { x: 'Fruits (Banana, Mango, etc.)', y: 530, text: '530 cal' },
  { x: 'Roti, Rice, Idli, Dosa', y: 950, text: '950 cal' },
];
